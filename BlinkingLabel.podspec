...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = 'https://github.com/kevinmthornton/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'kevinmthornton' => 'kevin.thornton@nike.com' }
  s.source           = { :git => 'https://github.com/kevinmthornton/BlinkingLabel.git', :tag => s.version.to_s }
